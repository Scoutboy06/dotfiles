    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            Column {
                ...
                Row {
                    width: parent.width
                    Text { text: "Notifications"; color: root.theme.foreground; font.bold: true; font.pixelSize: 14 }
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        Column {
                            ...
                            Text { width: parent.width; text: modelData.summary || modelData.app_name; color: root.theme.foreground; font.bold: true; elide: Text.ElideRight }
                            Text { width: parent.width; text: modelData.body || ""; color: root.theme.foreground; opacity: 0.75; wrapMode: Text.Wrap; maximumLineCount: 2; elide: Text.ElideRight }
                        }
